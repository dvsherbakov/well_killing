...
//Класс сохранения иноформации о расчете
    ...
    { //Объект для параметров трубы
        ...
        /*
        public CGeomethry ReturnGeomethry()
        {
            return new CGeomethry {Dout = Dout, W = W, Index = Index};
        }
        */
